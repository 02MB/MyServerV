...
registerCmd('veh', '/vehicle <name> | Summons a vehicle in front of a player.', handleAddVehicle);
...
function handleAddVehicle(player, args) {
  ...
  //if (player.lastVehicle && player.lastVehicle.valid) { // отключил уничтожение предыдущей машины
