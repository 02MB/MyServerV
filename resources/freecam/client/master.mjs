...
let freecam = {
    ...
    stop: function() {
        ...
        var camPos = { ...native.getCamCoord(freecam.camera) };
        alt.emitServer('freecam:setPosition', camPos.x, camPos.y, camPos.z);
        ...
        // alt.emitServer('freecam:setPlayerPosition');
...
function executeActions() {
    var camPos = { ...native.getCamCoord(freecam.camera) };
    var camRot = { ...native.getCamRot(freecam.camera, 2) };
    ...
    if (updatePos) {
        native.setCamCoord(freecam.camera, camPos.x, camPos.y, camPos.z);
    ...
    if (updateRot) {
        native.setCamRot(freecam.camera, camRot.x, camRot.y, camRot.z, 2);
